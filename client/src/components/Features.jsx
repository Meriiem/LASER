      ...
      <div className="w-full bg-white py-16 px-4">
        ...
        /> */}
          <div className="flex flex-col justify-center">
            ...
            <p>
              Transform lengthy lectures into concise summaries with our
              intelligent summarization algorithm. Our tool analyzes the
              transcribed content, identifies key points, and generates a
              well-structured summary. It's the perfect solution for students,
              professionals, and anyone looking to grasp the main ideas without
              wading through hours of content.
            </p>
            <button className="bg-[#83bdfd] text-white w-[200px] rounded-md font-medium my-6 mx-auto md:mx-0 py-3 ">
              Get started
            </button>
